...
public class WooCompletion {
    ...
    public typealias List<T: BaseMappable> = (_ success: Bool, _ value: [T]?, _ error: WooError?) -> Void
    ...
    ///   - error: An instance of `WooError` that includes a description of any error that exists. This parameter is nil if no error occurs.
    public typealias Object<T: BaseMappable> = (_ success: Bool, _ value: T?, _ error: WooError?) -> Void
    ...
    ///   - error: An instance of `WooError` that includes a description of any error that exists. This parameter is nil if no error occurs.
    public typealias Token = (_ success: Bool, _ token: String?, _ error: WooError?) -> Void
    ...
    ///   - success: The type of objects being requested.
    ///   - error: An instance of `WooError` that includes a description of any error that exists. This parameter is nil if no error occurs.
    public typealias Success = (_ success: Bool, _ error: WooError?) -> Void
